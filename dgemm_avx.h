...
static __declspec(align(32)) double _A[MC*KC];
static __declspec(align(32)) double _B[KC*NC];
static __declspec(align(32)) double _C[MR*NR];
                   ...
                   const double *a_next, const double *b_next)
{
	...
	_mm_prefetch( (const char *)b_next, 2 );
	_mm_prefetch( (const char *)c, 0 );
